...
def labelme2yolov2Seg(jsonfilePath=r"C:/", resultDirPath=r"C:/", classList=['ripeT', 'unripeT', 'semi','flower']):
    """
...
if __name__ == "__main__":
    jsonfilePath = r"C:/Users/Lzd/tomato/2024.6.15采集数据/resizetomato/train/json"  # 要转换的json文件所在目录
    resultDirPath = r"C:/Users/Lzd/tomato/2024.6.15采集数据/resizetomato/train/txt"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath,
                      classList=['ripeT', 'unripeT', 'semi','flower'])  # 更改为自己的类别名